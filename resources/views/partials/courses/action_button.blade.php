    ...
    @auth
        @can('opt_for_course', $course)
            @can('subscribe', \App\Course::class)
                <a href="{{ route('subscriptions.plans')}}" class="btn btn-subscribe btn-primary btn-bottom btn-block">
                <i class="fa fa-bolt"></i> {{ __("Subscribirme")}}
                </a>
            @else
                @can('inscribe', $course)
                    <a href="{{ route('courses.inscribe', ['slug' => $course->slug]) }}" class="btn btn-subscribe btn-primary btn-bottom btn-block">
        ...
        @endcan 
    @else
    <a href="{{ route('login')}}" class="btn btn-subscribe btn-primary btn-bottom btn-block">
